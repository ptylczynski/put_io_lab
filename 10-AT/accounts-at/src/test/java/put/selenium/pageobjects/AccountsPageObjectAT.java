...
public class AccountsPageObjectAT {
    ...
    public void successfulUserRegistration() throws Exception {
        ...
        assertTrue(this.mainPage.isOnPageNotLoggedIn());
        this.mainMenu.clickRegisterLink();
        assertTrue(this.registrationPage.isOnPage());
        ...
        assertTrue(this.loginPage.isOnPage());
